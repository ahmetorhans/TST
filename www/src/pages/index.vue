  ...
  <q-page>
    ...
    <div class="row q-pa-sm">
      <div class="col-xs-12 col-md-12">
        <q-toggle class="float-right	" v-model="servisListeleDurum" label="Tüm Servisleri Göster" />
          <div class="q-display-1 q-py-md" v-if="servisListeleDurum">Tüm Servisler</div>
          <div class="q-display-1 q-py-md" v-if="!servisListeleDurum">Servislerim</div>
...
const module = {
 ...
 watch:{
  ...
  methods: {
    ...
    getList () {
      axios
        .get(this.apiUrl + "servisListeleKendisi")
        .then(response => {
