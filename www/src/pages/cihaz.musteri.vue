          ...
          <div class="row">
            ...
            <div class="col-sm-10">
              ...
              <q-field class="fip">
                ...
                <q-btn color="secondary" @click="submit" v-if="currentCihaz.musteriKaydi=='1'">Kaydet</q-btn>
                <span v-if="currentCihaz.id">
                  <q-btn align="right" icon="delete" v-if="currentCihaz.musteriKaydi=='1'" color="negative" @click="sil(currentCihaz.id)"></q-btn>
                </span>
              </q-field>
            </div>
            <div class="col-sm-2">
            ...
            <q-item-main label-lines="1" sublabel-lines="1" dense>
              <q-item-tile sublabel>
                <div class="row">
                  ...
                  <div class="col-md-4 listCol">Marka / Model </div>
                  <div class="col-md-2 listCol">Serino </div>
                  <div class="col-md-4 listCol">Açıklama </div>
                  <div class="col-md-1 listCol">Cihaz </div>
